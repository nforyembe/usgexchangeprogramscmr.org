...
class Publication extends Feature
{
    ...
    function __construct()
    {
        ...
        $this->feature_category = 'publication_category';

        // For front end... the page on which the features will be displayed
        $this->feature_page = 'evidence';
        $this->template_preview = 'publication-preview.html';
        ...
        $this->feature_table = 'publications';
        $this->feature_content_table = 'publication_content';
        
        // Define the columns to join the feature content table to the feature table
        $this->join_column = 'publication_id';
